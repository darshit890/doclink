  ...
  return (
    <div className="flex flex-row gap-x-20 mt-[12rem] mx-auto justify-center ">
      ...
      <div className="flex flex-col justify-center">
        <h1 className="small-heading text-3xl font-semibold">Track activity</h1>
        <h4 className="text-5xl font-bold pt-1">All your needs</h4>
        <h4 className="text-5xl font-bold pt-1">in a single platform</h4>
